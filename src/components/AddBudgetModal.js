...
function AddBudgetModal({ myZVal, onCancelClick, toggleSomeChange }) {
    ...
    return (
        <div className = "flex items-center justify-center bg-black/30 absolute left-0 top-0 w-full h-full overflow-y-auto" style = {{zIndex: myZVal}}>
            <form onSubmit = {handleSubmit} className = "mx-4 w-full max-w-sm flex flex-col gap-y-8 p-6 rounded-md bg-blue-50">
