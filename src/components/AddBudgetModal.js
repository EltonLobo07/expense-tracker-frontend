...
function AddBudgetModal({ myZVal, onCancelClick, categories, setCategories, setBudgetFormZIndex }) {
    ...
    return (
        <div className = "flex items-start justify-center bg-black/30 absolute left-0 top-0 w-full h-full overflow-y-auto" style = {{zIndex: myZVal}} onClick = {onCancelClick} data-cancel = "yes">
            <form onSubmit = {handleSubmit} className = "mx-4 my-8 w-full max-w-lg flex flex-col gap-y-8 p-6 rounded-md bg-blue-50">
